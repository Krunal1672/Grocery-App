    ...
    <div className='relative'>
       <img  
        ...
        <div className="absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-24 md:pb-0 md:pl-18 lg:pl-24">
          ...
          <Link
            to={"/products"}
            className="flex group items-center gap-2 px-7 rounded text-white  py-3 bg-primary text-lg"
          >
            Shop Now
            <img
          ...
          <Link
            to={"/products"}
            className=" hidden md:flex group items-center gap-2 px-7 rounded text-white  py-3 bg-primary text-lg"
          > 
            Explore Deals
            <img
              src={assets.white_arrow_icon}
